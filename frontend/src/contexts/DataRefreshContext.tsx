...
type RefreshEvent = 'debit-created' | 'debit-updated' | 'debit-deleted' | 'credit-created' | 'credit-updated' | 'credit-deleted';
...
export function DataRefreshProvider({ children }: DataRefreshProviderProps) {
  ...
  const triggerRefresh = useCallback((event: RefreshEvent) => {
