...
export type ConceptColumn = Concept

/**
 * Definición de columnas para la tabla de conceptos
 * Soporta:
 * - Ordenamiento por nombre
 * - Acciones: edit y delete (solo se muestra si se pasan callbacks)
 */
export const createConceptsColumns = (
  onEdit?: (concept: Concept) => void,
  onDelete?: (concept: Concept) => void
): ColumnDef<ConceptColumn>[] => {
  const columns: ColumnDef<ConceptColumn>[] = [
    {
      accessorKey: 'name',
      id: 'name',
