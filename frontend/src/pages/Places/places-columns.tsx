...
export type PlaceColumn = Place

/**
 * Definición de columnas para la tabla de places
 * Soporta:
 * - Ordenamiento por nombre
 * - Acciones: edit y delete (solo se muestra si se pasan callbacks)
 */
export const createPlacesColumns = (
  onEdit?: (place: Place) => void,
  onDelete?: (place: Place) => void
): ColumnDef<PlaceColumn>[] => {
  const columns: ColumnDef<PlaceColumn>[] = [
    {
      accessorKey: 'name',
      id: 'name',
