...
class CreditSchema(Schema):
    ...
    credited_at = fields.DateTime(
        allow_none=True,
        format='iso',
        error_messages={'invalid': 'credited_at must be in ISO 8601 format (e.g., 2026-04-04T15:30:00)'}
    )
    ...
    class Meta:
        fields = ('id', 'amount', 'credited_at', 'observations')
